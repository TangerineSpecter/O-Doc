...
[![版本](https://img.shields.io/badge/version-0.9.12-blue.svg)](https://github.com/your-username/o-doc)
...
- **🔄 轻松云端同步** - 支持 WebDAV、FTP / FTPS、SFTP 自动同步与并发备份，具备快照防覆盖机制，确保数据安全
...
- **云端数据备份**：支持 WebDAV、FTP / FTPS、SFTP 备份与同步，确保数据不丢失
