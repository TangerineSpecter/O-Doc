...
export default function ImageGalleryFilters({
  ...
  return (
    <section className="sticky top-[57px] sm:top-[69px] z-30 mb-4 rounded-xl border border-slate-200/90 bg-white/95 px-3 py-2 sm:px-4 sm:py-2.5 shadow-xs backdrop-blur-md transition-all">
      ...
      {/* 展开详细筛选面板 */}
      {isExpanded && (
        <div className="mt-3 pt-3 border-t border-slate-200/70 animate-in fade-in slide-in-from-top-2 duration-150">
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-[minmax(120px,1fr)_minmax(130px,1fr)_minmax(200px,1.5fr)_minmax(160px,1.2fr)_auto] items-end">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-1.5">
                <input
                  ...
                  placeholder="最小"
                  className="min-h-9 w-full rounded-lg border border-slate-200 bg-white px-2.5 py-1 text-xs text-slate-700 outline-none transition-all placeholder:text-slate-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20"
                />
                <input
                  type="number"
                  min="0"
            ...
            <div className="flex items-center gap-2">
              {hasGalleryFilters && (
                <button
                  type="button"
                  onClick={onClearFilters}
                  className="flex min-h-9 w-full sm:w-auto items-center justify-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 transition-colors hover:border-orange-200 hover:bg-orange-50 hover:text-orange-700"
                >
              ...
              <button
                ...
                className="flex min-h-9 w-full sm:w-auto items-center justify-center rounded-lg bg-slate-100 hover:bg-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-700 transition-colors"
              >
                收起
              </button>
            </div>
