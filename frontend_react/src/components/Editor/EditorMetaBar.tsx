                ...
                <div className="relative z-50">
                    ...
                    {isParentOpen && (
                        <>
                            ...
                            <div className="absolute top-full left-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-slate-100 py-1 animate-in fade-in zoom-in-95 duration-100 overflow-hidden z-[100]">
