...
export default function NodeCorrections({bookId, node, nodes, edges, onSaved}: Props) {
    ...
    const [profileAttribute, setProfileAttribute] = useState<'identity' | 'age' | 'occupation' | 'role' | 'trait' | 'background' | 'behavior' | 'goal'>('identity');
