...
import {BookItem, deleteBook, getBookProgress, getBooks, releaseBook, repairBookUpload, restoreBook, saveBookProgress, uploadBook} from '../api/anthology';
...
export default function BookAnthologyPage({collId, onNavigate}: Props) {
    ...
    const [books, setBooks] = useState<BookItem[]>([]); const [loading, setLoading] = useState(true); const [selected, setSelected] = useState<BookItem | null>(null); const [reading, setReading] = useState<BookItem | null>(null); const [releaseCandidate, setReleaseCandidate] = useState<BookItem | null>(null); const [deleteCandidate, setDeleteCandidate] = useState<BookItem | null>(null); const [repairCandidate, setRepairCandidate] = useState<BookItem | null>(null); const [isActionLoading, setIsActionLoading] = useState(false);
