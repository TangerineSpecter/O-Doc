...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Anthology',
            fields=[
                ('coll_id', models.CharField(default=utils.id_generator.generate_coll_id, max_length=40, primary_key=True, serialize=False, unique=True, verbose_name='文集唯一标识')),
                ...
                ('rag_not_synced_count', models.IntegerField(default=0, verbose_name='未同步RAG文章数量')),
